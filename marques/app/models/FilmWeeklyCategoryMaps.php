...
/**
 * Model used to manage Film Weekly Category Map records
 */
class FilmWeeklyCategoryMaps extends \lithium\data\Model {
	...
	public $validates = array(
		...
		'film_weekly_categories_id' => array(
			array('notEmpty', 'message' => 'A film weekly category record id is required'),
			array('numeric',  'message' => 'A film weekly category id must be a numeric value')
		)
	);
}
